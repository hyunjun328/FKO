...
export const FORMER_UFC_FIGHTERS: ArchiveFighter[] = [
  ...
  { name: "Conor McGregor", koName: "코너 맥그리거", record: "22-6-0", era: "전 UFC 페더급 · 라이트급 챔피언", note: "UFC 최초의 동시 두 체급 챔피언으로, 전 세계적인 흥행을 이끈 아일랜드 스타.", sourceUrl: "https://www.ufc.com/athlete/conor-mcgregor" },
  { name: "Amanda Nunes", koName: "아만다 누네스", record: "23-5-0", era: "전 UFC 여성 밴텀급 · 페더급 챔피언", note: "두 체급 정상에서 장기간 타이틀을 방어한 여성 MMA의 대표적인 챔피언.", sourceUrl: "https://www.ufc.com/athlete/amanda-nunes" },
  { name: "Henry Cejudo", koName: "헨리 세후도", record: "16-4-0", era: "전 UFC 플라이급 · 밴텀급 챔피언", note: "올림픽 레슬링 금메달 뒤 UFC 두 체급 챔피언까지 달성한 ‘트리플 C’.", sourceUrl: "https://www.ufc.com/athlete/henry-cejudo" },
  { name: "Eddie Alvarez", koName: "에디 알바레즈", record: "30-8-0", era: "전 UFC 라이트급 챔피언", note: "벨라토르와 UFC 정상에 모두 오른 필라델피아 출신 라이트급 베테랑.", sourceUrl: "https://www.ufc.com/athlete/eddie-alvarez" },
  { name: "Anthony Pettis", koName: "앤서니 페티스", record: "25-14-0", era: "전 UFC 라이트급 챔피언", note: "WEC의 ‘쇼타임 킥’부터 UFC 라이트급 타이틀까지 이어진 창의적 스트라이커.", sourceUrl: "https://www.ufc.com/athlete/anthony-pettis" },
  { name: "Benson Henderson", koName: "벤슨 헨더슨", record: "30-12-0", era: "전 UFC 라이트급 챔피언", note: "끈질긴 그래플링과 체력으로 라이트급 타이틀을 세 차례 방어한 챔피언.", sourceUrl: "https://www.ufc.com/athlete/benson-henderson" },
  { name: "Nate Diaz", koName: "네이트 디아즈", record: "22-13-0", era: "TUF 우승 · UFC 대표 스타", note: "주짓수와 압박 복싱, 강한 맷집으로 맥그리거전 등 UFC 대표 흥행전을 만든 스톡턴 스타.", sourceUrl: "https://www.ufc.com/athlete/nate-diaz" },
  { name: "Nick Diaz", koName: "닉 디아즈", record: "26-10-2", era: "전 스트라이크포스 웰터급 챔피언", note: "끝없는 압박 타격과 주짓수로 닉 디아즈 Army를 만든 웰터급 아이콘.", sourceUrl: "https://www.ufc.com/athlete/nick-diaz" },
  { name: "Chael Sonnen", koName: "체일 소넨", record: "31-17-1", era: "전 UFC 미들급 · 라이트헤비급 타이틀 도전자", note: "엘리트 레슬링과 마이크워크로 앤더슨 실바 시대의 가장 큰 라이벌 구도를 만들었다.", sourceUrl: "https://www.ufc.com/athlete/chael-sonnen" },
  { name: "Rashad Evans", koName: "라샤드 에반스", record: "19-8-1", era: "전 UFC 라이트헤비급 챔피언", note: "TUF 우승 후 포레스트 그리핀을 꺾고 라이트헤비급 정상에 오른 레슬러.", sourceUrl: "https://www.ufc.com/athlete/rashad-evans" },
  { name: "Dan Henderson", koName: "댄 헨더슨", record: "32-15-0", era: "PRIDE · 스트라이크포스 챔피언", note: "올림픽 레슬링과 ‘H-Bomb’ 오른손으로 PRIDE와 UFC 시대를 아우른 전설.", sourceUrl: "https://www.ufc.com/athlete/dan-henderson" },
  { name: "Alistair Overeem", koName: "알리스타 오브레임", record: "47-19-1", era: "전 스트라이크포스 헤비급 챔피언", note: "K-1 월드 그랑프리와 MMA 정상급 무대를 모두 경험한 네덜란드 헤비급 스타.", sourceUrl: "https://www.ufc.com/athlete/alistair-overeem" },
  { name: "Mark Hunt", koName: "마크 헌트", record: "13-14-1", era: "K-1 월드 그랑프리 우승", note: "‘슈퍼 사모안’의 강력한 오른손과 명승부로 PRIDE·UFC 헤비급에 족적을 남겼다.", sourceUrl: "https://www.ufc.com/athlete/mark-hunt" },
  { name: "Glover Teixeira", koName: "글로버 테세이라", record: "33-9-0", era: "전 UFC 라이트헤비급 챔피언", note: "42세에 UFC 라이트헤비급 타이틀을 차지한 브라질 출신 주짓수·복싱 베테랑.", sourceUrl: "https://www.ufc.com/athlete/glover-teixeira" },
  { name: "Demian Maia", koName: "데미안 마이아", record: "28-13-0", era: "전 UFC 미들급 · 웰터급 타이틀 도전자", note: "현대 MMA에서 가장 높은 수준의 주짓수 압박을 보여 준 브라질 그래플러.", sourceUrl: "https://www.ufc.com/athlete/demian-maia" },
  { name: "T.J. Dillashaw", koName: "TJ 딜라쇼", record: "18-5-0", era: "전 UFC 밴텀급 챔피언", note: "도미닉 크루즈와 코디 가브란트 등을 상대로 밴텀급 최정상 경쟁을 펼친 챔피언.", sourceUrl: "https://www.ufc.com/athlete/tj-dillashaw" },
  { name: "Renan Barao", koName: "헤난 바라오", record: "34-9-0", era: "전 UFC 밴텀급 챔피언", note: "WEC 통합 후 밴텀급 타이틀을 차지하고 긴 무패 행진을 이어간 브라질 챔피언.", sourceUrl: "https://www.ufc.com/athlete/renan-barao" },
  { name: "Carla Esparza", koName: "칼라 에스파르자", record: "22-7-0", era: "전 UFC 여성 스트로급 챔피언", note: "TUF 20 우승으로 초대 UFC 여성 스트로급 챔피언이 된 뒤 두 번째 정상에도 올랐다.", sourceUrl: "https://www.ufc.com/athlete/carla-esparza" },
  { name: "Germaine de Randamie", koName: "저메인 드 란다미", record: "10-5-0", era: "초대 UFC 여성 페더급 챔피언", note: "UFC 최초 여성 페더급 타이틀전에서 정상에 오른 네덜란드 출신 스트라이커.", sourceUrl: "https://www.ufc.com/athlete/germaine-de-randamie" },
  { name: "Rory MacDonald", koName: "로리 맥도널드", record: "24-10-1", era: "전 UFC 웰터급 타이틀 도전자", note: "로비 라울러와의 UFC 189 명승부를 포함해 웰터급 세대를 대표한 캐나다 파이터.", sourceUrl: "https://www.ufc.com/athlete/rory-macdonald" },
];
