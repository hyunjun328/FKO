...
export const EVENTS: FightEvent[] = [
  {
    ...
    bouts: [
      { left: "Uros Medic", right: "Daniel Rodriguez", weight: "웰터급", section: "main" },
      { left: "Jan Blachowicz", right: "Navajo Stirling", weight: "라이트헤비급", section: "main" },
      { left: "Aleksandar Rakic", right: "Marcin Tybura", weight: "헤비급", section: "main" },
      { left: "Dusko Todorovic", right: "Robert Valentin", weight: "미들급", section: "main" },
      ...
      { left: "Mateusz Rebecki", right: "Kyle Prepolec", weight: "라이트급", section: "prelims" },
  ...
  },
  {
    ...
    bouts: [
      ...
      { left: "Jalin Turner", right: "Kaue Fernandes", weight: "라이트급", section: "announced" },
